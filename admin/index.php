...
echo "<script>alert('Utilisateur pas encore enregistre');</script>";
  }
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>infosmarchespublics| Administrateur Partie</title>
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group ">
                                            <div class="col-xs-12">
                                                <input class="form-control" type="text" required="" name="username" placeholder="Nom utilisateur ou Email" autocomplete="off">
                                            </div>
                                        </div>
