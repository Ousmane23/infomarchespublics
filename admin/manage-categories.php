...
if($_GET['resid'])
{
	...
	$msg="Categorie restaurée avec succès";
}
...
if($_GET['action']=='parmdel' && $_GET['rid'])
{
	...
	$delmsg="Categorie supprimée pour toujours";
}
...
<html lang="en">
    <head>
        ...
        <title>infosmarchespublics | Gérer les categories</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Gérer les categories</h4>
...
<strong>Executé avec succès!</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>

<?php if($delmsg){ ?>
<div class="alert alert-danger" role="alert">
<strong>Oooups!</strong> <?php echo htmlentities($delmsg);?></div>
<?php } ?>
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Categories supprimées</h4>
...
<td><?php echo htmlentities($row['PostingDate']);?></td>
<td><?php echo htmlentities($row['UpdationDate']);?></td>
<td><a href="manage-categories.php?resid=<?php echo htmlentities($row['id']);?>"><i class="ion-arrow-return-right" title="Restaurez cette categorie"></i></a> 
	&nbsp;<a href="manage-categories.php?rid=<?php echo htmlentities($row['id']);?>&&action=parmdel" title="Supprimer pour toujours"> <i class="fa fa-trash-o" style="color: #f05050"></i> </td>
</tr>
<?php
$cnt++;
 } ?>
