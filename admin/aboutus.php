...
if($query)
{
$msg="La page Presentation mis à jour avec succès";
}
else{
$error="Une erreur est survenue. Veuillez réessayer encore";    
} 
...
<html lang="en">
    <head>
        ...
        <meta name="description" content="ABC Formation">
        <meta name="author" content="Niger">

        <!-- App favicon -->
        <link rel="shortcut icon" href="assets/images/favicon.ico">
        <!-- App title -->
        <title>infosmarchespublics | Presentation</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Page Presentation </h4>
...
<strong>Félicitations !!!</strong> <?php echo htmlentities($msg);?>
</div>
<?php } ?>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b> Details de la Page</b></h4>
...
<button type="submit" name="update" class="btn btn-success waves-effect waves-light">Mise à jour et l'annonce</button>
